/**
 * A lightweight Virtual File System (VFS) for file system /
 * network / class path scanning. Most Ferret users should not have to
 * worry about the classes in this package beyond knowing how to tell the
 * difference between a zip file and a class file or directory. Underlying
 * resources on the file system or on the network will be mapped to one of
 * the following VFS types:
 * 
 * <style>
 * .mytable {
 ...
 *  	</tr>
 *   	<tr>
 *   		<td class="mytable">A zip, jar or other archive file on the local file system</td>
 *   		<td class="mytable">{@link Archive}</td>
 *   	</tr>
 *  	<tr>
 *  		<td class="mytable">A zip, jar or other archive file on the network</td>
 *  		<td class="mytable">{@link Archive}</td>
 *  	</tr>
 *   	<tr>
